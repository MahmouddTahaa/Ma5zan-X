...
P_ORDER_CREATE = 0.60
P_ADVANCE_ORDER = 0.20
P_CUSTOMER_REG = 0.10
P_STOCK_ADJUST = 0.05
P_RESTOCK_CHECK = 0.05
...
SIM_SPEED_FACTOR = 300  # simulated seconds per real second (5 sim minutes per real sec)
STATE_DB_PATH = os.getenv("STATE_DB_PATH", "producer_state.db")
